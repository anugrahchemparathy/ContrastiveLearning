...
def training_loop(args):
    ...
    """
    save_progress_path = os.path.join(SCRIPT_PATH, "saved_models", args.encoder_path + '_finetune')
    ...
    encoder = torch.load('saved_models/' + args.encoder_path + '/' + args.encoder_time + '_encoder.pt')
    ...
    plot_loss(losses, title = args.encoder_path + '_finetune', save_progress_path = save_progress_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder_path', default='rmse_1500_a', type=str)
    parser.add_argument('--encoder_time', default='final', type=str)
    ...
    # parser.add_argument('--fname', default='rmse_1500_a_finetune' , type = str)
    parser.add_argument('--data_config', default='orbit_config_finetune_noise.json' , type = str)
